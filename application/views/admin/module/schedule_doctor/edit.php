...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Data Jadwal Dokter</h1>
            <ol class="breadcrumb">
                ...
                <div class="container-form">
                  <form onsubmit="return submitForm();" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <select class="form-control input-length" id="doctor" name="doctor" disabled="">
                        <option value="">-- Pilih Dokter -- </option>
                        <?php foreach ($doctor_datas as $doctor) {?>
                          <option value="<?=$doctor->id;?>" <?=$doctor->id == $doctor_selected ? 'selected' : '';?>><?=$doctor->name;?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <!-- Senin -->
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <div class="row input-clock-length">
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="senin_1" name="senin" value="<?=$senin1?>" autocomplete="off">                     
                        ...
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="senin_2" value="<?=$senin2?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                    ...
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <div class="row input-clock-length">
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="selasa_1" name="selasa" value="<?=$selasa1?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                        ...
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="selasa_2" value="<?=$selasa2?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                    ...
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <div class="row input-clock-length">
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="rabu_1" name="" value="<?=$rabu1?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                        ...
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="rabu_2" value="<?=$rabu2?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                    ...
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <div class="row input-clock-length">
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="kamis_1" name="" value="<?=$kamis1?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                        ...
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="kamis_2" value="<?=$kamis2?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                    ...
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <div class="row input-clock-length">
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="jumat_1" name="jumat" value="<?=$jumat1?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                        ...
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="jumat_2" value="<?=$jumat2?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                    ...
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <div class="row input-clock-length">
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="sabtu_1" name="sabtu" value="<?=$sabtu1?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                        ...
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="sabtu_2" value="<?=$sabtu2?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                    ...
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <div class="row input-clock-length">
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="minggu_1" name="minggu" value="<?=$minggu1?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
                        ...
                        <div class="col-md-5">
                          ...
                          <input type="text" class="form-control" id="minggu_2" value="<?=$minggu2?>" autocomplete="off">                     
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                          </div>                      
                        </div>
  ...
  <form id="val_submit" action="<?=base_url('administrator/schedule_doctor/update')?>" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?=$id;?>">
    <input type="hidden" name="doctor" id="val_doctor" value="<?=$doctor_selected?>">
