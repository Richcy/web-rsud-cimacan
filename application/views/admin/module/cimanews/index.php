...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Cimanews</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Content</li>
              <li class="breadcrumb-item">Article</li>
              <li class="breadcrumb-item active" aria-current="page">Cimanews</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold primary-color">Cimanews</h6>
                  <a href="<?=base_url('administrator/cimanews/add')?>" class="btn btn-primary"><span><i class="fa fa-plus"></i></span> Add Data</a>
                </div>
                    ...
                    <tbody id="">
                      ...
                      <tr class="sort-wrap" data-snum="<?=$num;?>" data-sid="<?=$data->id;?>">
                        <td style="width: 20%;">
                          ...
                          <a href="<?=base_url('administrator/cimanews/edit/').$data->id;?>" style="font-size: 12px;" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                        </td>
                        ...
                        <td><?=$data->author;?></td>
                        <td><?=$data->title;?></td>
                        <td><?=$data->sub_desc ? substr($data->sub_desc,0,50) : substr($data->description,0,50);?>....</td>
  ...
  <script type="text/javascript">
    ...
    function save_sort(){
      ...
      var url = "<?=base_url('administrator/cimanews/save_sort')?>";
      $.ajax({
        type:'POST',
        url: url, 
        data : {data_id: order}, 
    ...
    function confirmDelete(id){
      ...
      .then((willDelete) => {
        if (willDelete) {
          var url = "<?=base_url('administrator/cimanews/delete')?>";
          $.ajax({
            type:'POST',
            url: url, 
            data : {id: id}, 
