      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Data Event</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="container-form">
                  <form id="form-Event" action="<?=base_url('administrator/event/create')?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <textarea name="sub_desc" class="form-control" maxlength="200"></textarea>
                    </div>
                    ...
                    <div class="form-group" id="start_date">
                      ...
                      <div class="input-group date input-length">
                        ...
                        <input type="text" class="form-control" value="" id="input_start_date" name="start_date" autocomplete="off">
                      </div>
                    ...
                    <div class="form-group" id="start_date">
                      ...
                      <div class="input-group date input-length">
                        ...
                        <input type="text" class="form-control" value="" id="input_end_date" name="end_date" autocomplete="off">
                      </div>
                    ...
                    <div>
                      <label for="exampleInputEmail1" class="form-label">Event's Poster <span class="required-fill">*</span></label>
                      <div>
