      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Penilaian Mutu</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">About Hospital</li>
              <li class="breadcrumb-item active" aria-current="page">Penilaian Mutu</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="container-form">
                  <form action="<?=base_url('administrator/quality_check/create')?>" method="POST" enctype="multipart/form-data" onsubmit="return validation_form();">
                    <input type="hidden" name="id" value="<?=$datas ? $datas[0]->id : 'empty'?>">
                    <div>
                      <label for="exampleInputEmail1" class="form-label">Penilaian Mutu</label>
                      <div>
