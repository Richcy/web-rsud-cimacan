      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Radiology</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Content</li>
              <li class="breadcrumb-item" aria-current="page">Service</li>
              <li class="breadcrumb-item active" aria-current="page">Radiology</li>
            </ol>
          </div>
              ...
              <div class="card mb-4">
                <div class="container-form">
                  ...
                  <ul class="nav nav-tabs" style="margin-bottom: 5%;">
                    <li class="nav-item">
                      <a class="nav-link active" href="<?=base_url('administrator/radiology')?>">Description</a>
                    </li>
                    <?php 
                      if ($datas) {
                        if ($datas[0]->id) {
                  ...
                  <form action="<?=base_url('administrator/radiology/create')?>" method="POST" enctype="multipart/form-data" onsubmit="return validation_form();">
                    ...
                    <div>
                      <label for="exampleInputEmail1" class="form-label">Banner Radiology</label>
                      <div>
