      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Radiology's Sub Menu</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="container-form">
                  <form id="form-sub-menu" action="<?=base_url('administrator/radiology/create_sub_menu')?>" method="POST" enctype="multipart/form-data">
