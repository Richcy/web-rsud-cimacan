...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Radiology's Sub Menu</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Content</li>
              <li class="breadcrumb-item" aria-current="page">Service</li>
              <li class="breadcrumb-item" aria-current="page"><a style="text-decoration: none; color: inherit;" href="<?=base_url('administrator/radiology')?>">Radiology</a></li>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <!-- Tab menu content -->
                  <div class="p-3">
                    <ul class="nav nav-tabs">
                      <li class="nav-item">
                        <a class="nav-link" href="<?=base_url('administrator/radiology')?>">Description</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="<?=base_url('administrator/radiology/sub_menu/').$service_id.'/'?>">Sub Menu</a>
                      </li>
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold primary-color">Radiology's Sub Menu</h6>
                  <a href="<?=base_url('administrator/radiology/add_sub_menu/').$service_id.'/'?>" class="btn btn-primary"><span><i class="fa fa-plus"></i></span> Add Data</a>
                </div>
                    ...
                    <tbody id="table_body">
                      ...
                      <tr class="sort-wrap" data-snum="<?=$num;?>" data-sid="<?=$data->id;?>">
                        <td style="width: 20%;">
                          ...
                          <a href="<?=base_url('administrator/radiology/edit_sub_menu/').$data->id.'/';?>" style="font-size: 12px;" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                        </td>
                        <td><?=$num;?></td>
                        <td>
                          <?=$data->title;?>
  ...
  <script type="text/javascript">
    ...
    function confirmDelete(id){
      ...
      .then((willDelete) => {
        if (willDelete) {
          var url = "<?=base_url('administrator/radiology/delete_sub_menu')?>";
          $.ajax({
            type:'POST',
            url: url, 
            data : {id: id}, 
