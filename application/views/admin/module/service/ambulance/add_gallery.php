      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Ambulance</h1>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page"> <a style="text-decoration: none; color: inherit;" href="<?=base_url('administrator/Ambulance/gallery')?>"> Gallery </a></li>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="container-form">
                  <form action="<?=base_url('administrator/Ambulance/create_gallery')?>" method="POST" enctype="multipart/form-data">
                    <div>
                      <label for="exampleInputEmail1" class="form-label">Ambulance Image</label>
                      <div>
                    ...
                    <div>
                      <input type="file" class="form-control" id="" name="gallery_ambulance" style="width: 30%; display: inline;" onchange="previewImage(event)" accept="image/*">
