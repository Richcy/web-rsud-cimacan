      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tartimah</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Content</li>
              <li class="breadcrumb-item" aria-current="page">Service</li>
              <li class="breadcrumb-item active" aria-current="page">Tartimah</li>
            </ol>
          </div>
              ...
              <div class="card mb-4">
                <div class="container-form">
                  ...
                  <ul class="nav nav-tabs" style="margin-bottom: 5%;">
                    <li class="nav-item">
                      <a class="nav-link active" href="<?=base_url('administrator/tartimah')?>">Description</a>
                    </li>
                    <?php 
                      if ($datas) {
                        if ($datas[0]->id) {
                    ?>
                      <li class="nav-item">
                        <a class="nav-link" href="<?=base_url('administrator/tartimah/sub_menu/').$datas[0]->id.'/'?>">Sub Menu</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?=base_url('administrator/tartimah/gallery')?>">Gallery</a>
                      </li>
                    <?php 
                        } 
                      }
                  ...
                  <form action="<?=base_url('administrator/tartimah/create')?>" method="POST" enctype="multipart/form-data" onsubmit="return validation_form();">
                    ...
                    <div>
                      <label for="exampleInputEmail1" class="form-label">Banner Tartimah</label>
                      <div>
