...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Layanan Unggulan's Sub Menu</h1>
            <ol class="breadcrumb">
                ...
                <!-- Tab menu content -->
                  <div class="p-3">
                    <ul class="nav nav-tabs">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="<?=base_url('administrator/unggulan/sub_menu/').$service_id.'/'?>">Sub Menu</a>
                      </li>

                      <li class="nav-item">
                        <a class="nav-link" href="<?=base_url('administrator/unggulan/gallery/')?>">Gallery</a>
                      </li>
                    </ul>
                  </div>
                  <!-- End tab menu content -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold primary-color">Layanan Unggulan's Sub Menu</h6>
                  <a href="<?=base_url('administrator/unggulan/add_sub_menu/').$service_id.'/'?>" class="btn btn-primary"><span><i class="fa fa-plus"></i></span> Add Data</a>
                </div>
                    ...
                    <tbody id="table_body">
                      ...
                      <tr class="sort-wrap" data-snum="<?=$num;?>" data-sid="<?=$data->id;?>">
                        <td style="width: 20%;">
                          ...
                          <a href="<?=base_url('administrator/unggulan/edit_sub_menu/').$data->id.'/';?>" style="font-size: 12px;" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                        </td>
                        <td><?=$num;?></td>
                        <td>
                          <?=$data->title;?>
  ...
  <script type="text/javascript">
    ...
    function confirmDelete(id){
      ...
      .then((willDelete) => {
        if (willDelete) {
          var url = "<?=base_url('administrator/unggulan/delete_sub_menu')?>";
          $.ajax({
            type:'POST',
            url: url, 
            data : {id: id}, 
