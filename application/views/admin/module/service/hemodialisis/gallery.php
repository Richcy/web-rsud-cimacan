...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Hemodialisis Gallery</h1>
            <ol class="breadcrumb">
                ...
                <!-- Tab menu content -->
                  <div class="p-3">
                    <ul class="nav nav-tabs">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="<?=base_url('administrator/hemodialisis/sub_menu/').$datas_hemodialisis[0]->id;?>">Sub Menu</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="<?=base_url('administrator/hemodialisis/gallery/')?>">Gallery</a>
                      </li>
                    </ul>
                  </div>
                  <!-- End tab menu content -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold primary-color">Hemodialisis's Gallery</h6>
                  <a href="<?=base_url('administrator/hemodialisis/add_gallery')?>" class="btn btn-primary"><span><i class="fa fa-plus"></i></span> Add Data</a>
                </div>
  ...
  <script type="text/javascript">
    ...
    function save_sort(){
      ...
      var url = "<?=base_url('administrator/hemodialisis/save_sort')?>";
      $.ajax({
        type:'POST',
        url: url, 
        data : {data_id: order}, 
    ...
    function confirmDelete(id){
      ...
      .then((willDelete) => {
        if (willDelete) {
          var url = "<?=base_url('administrator/hemodialisis/delete_gallery')?>";
          $.ajax({
            type:'POST',
            url: url, 
            data : {id: id}, 
