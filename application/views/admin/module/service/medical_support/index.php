      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Penunjang Medis</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Content</li>
              <li class="breadcrumb-item" aria-current="page">Service</li>
              <li class="breadcrumb-item active" aria-current="page">Penunjang Medis</li>
            </ol>
          </div>
              ...
              <div class="card mb-4">
                <div class="container-form">
                  ...
                  <ul class="nav nav-tabs" style="margin-bottom: 5%;">
                    <li class="nav-item">
                      <a class="nav-link active" href="<?=base_url('administrator/medical_support')?>">Description</a>
                    </li>
                    <?php 
                      if ($datas) {
                        if ($datas[0]->id) {
                    ?>
                      <li class="nav-item">
                        <a class="nav-link" href="<?=base_url('administrator/medical_support/gallery')?>">Gallery</a>
                      </li>
                    <?php 
                        } 
                      }
                  ...
                  <form action="<?=base_url('administrator/medical_support/create')?>" method="POST" enctype="multipart/form-data" onsubmit="return validation_form();">
                    <input type="hidden" name="id" value="<?=$datas ? $datas[0]->id : 'empty';?>">
                    <div class="mb-3" style="margin-top: 2%;">
                      <medical_supportel class="form-medical_supportel">Description <span class="required-fill">*</span> </medical_supportel>
                    ...
                    <div>
                      <medical_supportel for="exampleInputEmail1" class="form-medical_supportel">Banner Penunjang Medis</medical_supportel>
                      <div>
