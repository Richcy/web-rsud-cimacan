...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Data Doctor</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="container-form">
                  <form id="form-doctor" action="<?=base_url('administrator/doctor/update')?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <select class="form-control input-length" name="field" id="field" required="">
                        ...
                        <?php foreach ($fields as $field) {?>
                          <option value="<?=$field->id;?>" <?=$field->id == $datas[0]->field ? 'selected' : '';?>><?=$field->name;?></option>
                        <?php } ?>
                      </select>
                    </div>
                    ...
                    <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <input type="text" class="form-control input-length" id="office" name="office" required="" value="<?=$datas[0]->office?>">
                    </div>
                    ...
                    <!-- <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <div class="row input-clock-length">
                        <div class="col-md-5">
                          ...
                          <input type="number" class="form-control" name="year" value="<?=$datas[0]->year?>" autocomplete="off">                     
                        ...
                        <div class="col-md-5">
                          <div class="input-group">
                          <input type="number" class="form-control" name="month" value="<?=$datas[0]->month?>" autocomplete="off">                     
                          <div class="input-group-append">
                    ...
                    <!-- <div class="mb-3" style="margin-top: 2%;">
                      ...
                      <input type="text" class="form-control input-length" id="alumni" name="alumni" required="" value="<?=$datas[0]->alumni;?>">
                    </div> -->

                    <!-- <div class="mb-3" style="margin-top: 2%;">
                      <label class="form-label">NIP</label>
                      <input type="text" class="form-control input-length" id="nip" name="nip" required="" value="<?=$datas[0]->nip;?>">
                    </div> -->

                    <!-- <div class="mb-3" style="margin-top: 2%;">
                      <label class="form-label">STR <span class="required-fill">*</span></label>
                      <input type="text" class="form-control input-length" id="str" name="str" required="" value="<?=$datas[0]->str;?>">
                    </div> -->

                    <div class="mb-3" style="margin-top: 2%;">
                      <label class="form-label">SIP <span class="required-fill">*</span></label>
                      <input type="text" class="form-control input-length" id="sip" name="sip" required="" value="<?=$datas[0]->sip;?>">
                    </div>
                    ...
                    <div>
                      ...
                      <div>
                        <!-- <a id="link-zoom" href="<?=base_url()?>assets/uploads/default-image.jpg" class="ngalleryswiper-zoom gallery-lightbox"> -->
                          <img id="preview-image" style="max-width: 245px; margin-bottom: 1%;" src="<?=$datas[0]->img ? base_url().'assets/uploads/'.$datas[0]->img : base_url().'assets/uploads/default-image.jpg'?>">
                        <!-- </a> -->
                      </div>
                    ...
                    <div style="text-align: right;">
                      <button type="button" onclick="checkData('<?=$datas[0]->id?>', '<?=$datas[0]->sip;?>', '<?=$datas[0]->nip;?>');" class="btn btn-primary">Submit</button>
                    </div>
                  </form>
                </div>
              </div>
  ...
  <script type="text/javascript">
    ...
    function checkData() {
      ...
      var url = "<?=base_url('administrator/doctor/checkDataEM')?>";
      $.ajax({
        type:'POST',
        url: url, 
        data : {sip: sip, nip: nip, id: id},
