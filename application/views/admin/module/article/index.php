...
<body id="page-top">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold primary-color">Article</h6>
                  <a href="<?=base_url('administrator/article/add')?>" class="btn btn-primary"><span><i class="fa fa-plus"></i></span> Add Data</a>
                </div>
                    ...
                    <tbody id="">
                      ...
                      <tr class="sort-wrap" data-snum="<?=$num;?>" data-sid="<?=$data->id;?>">
                        <td style="width: 20%;">
                          ...
                          <a href="<?=base_url('administrator/article/edit/').$data->id;?>" style="font-size: 12px;" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                        </td>
  ...
  <script type="text/javascript">
    ...
    function save_sort(){
      ...
      var url = "<?=base_url('administrator/article/save_sort')?>";
      $.ajax({
        type:'POST',
        url: url, 
        data : {data_id: order}, 
    ...
    function confirmDelete(id){
      ...
      .then((willDelete) => {
        if (willDelete) {
          var url = "<?=base_url('administrator/article/delete')?>";
          $.ajax({
            type:'POST',
            url: url, 
            data : {id: id}, 
