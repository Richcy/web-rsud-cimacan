              ...
              <div class="card mb-4">
                <div class="container-form">
                  ...
                  <ul class="nav nav-tabs" style="margin-bottom: 5%;">
                    <li class="nav-item">
                      <a class="nav-link active" href="<?=base_url('administrator/about_company')?>">Description</a>
                    </li>
                    <?php 
                      if ($datas) {
                        if ($datas[0]->id) {
                    ?>
                      <li class="nav-item">
                        <a class="nav-link" href="<?=base_url('administrator/about_company/gallery')?>">Gallery</a>
                      </li>
                    <?php 
                        } 
                      }
                  ...
                  <form action="<?=base_url('administrator/about_company/create')?>" method="POST" enctype="multipart/form-data" onsubmit="return validation_form();">
