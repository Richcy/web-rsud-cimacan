         ...
         <div class="listbox-pagination">
          <ul>
            ...
            <?php if ($totalPage >5) {?>
              ...
              <li>
                <?php if ($category_selected != '' || $s != '') {?>
                  <a href="<?=base_url().'event/1?category='.$category_selected.'&s='.$s;?>" class="pagination-link">
                <?php }else{ ?>
                  <a href="<?=base_url().'event/1/';?>" class="pagination-link">
                <?php } ?>
              ...
              <li>
                <?php if ($category_selected != '' || $s != '') {?>
                  <a href="<?=base_url().'event/'.($totalPage).'?category='.$category_selected.'&s='.$s;?>" class="pagination-link">
                <?php }else{ ?>
                  <a href="<?=base_url().'event/'.($totalPage).'/';?>" class="pagination-link">
                <?php } ?>
                  <i class="fa fa-angle-right"></i>
                  <i class="fa fa-angle-right"></i>
                </a>
