  ...
  <div class="space-xs visible-xs"></div>
    <div class="container banner">
      ...
      <div class="breadcrumb-part">
        ...
        <span><i class="fa fa-angle-right"></i></span>
        <a href="javascript:void(0);">Maklumat Pelayanan</a>
      </div>
      <!-- End breadcumb -->
    ...
    <section id="content" class="main-page">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h1 class="title-page">Maklumat Pelayanan RSUD Cimacan</h1>
        </div>
        ...
        <div class="container">
          <div class="content-section">
            <div class="row">
              <div class="col-md-12">
                <img class="Maklumat Pelayanan-rs denah-rs" src="<?php echo base_url().'assets/uploads/'.$datas[0]->img;?>">
              </div>
