<meta charset="utf-8">
  ...
  <meta name="google-site-verification" content="6bpDyYydC54VM32NjSRmYp3-0OG-P-duqOT3N66A3FA" />
  ...
  <link href="<?php echo base_url();?>assets/fe/vendor/animate.css/animate.min.css" rel="stylesheet">

  <link href="<?php echo base_url();?>assets/fe/vendor/aos/aos.css" rel="stylesheet">
  ...
  <link href="<?php echo base_url();?>assets/fe/css/style.css?<?=mt_rand();?>" rel="stylesheet">

  <link href="<?php echo base_url();?>assets/fe/css/style-fe-plus.css?<?=mt_rand();?>" rel="stylesheet">

  <link href="<?php echo base_url();?>assets/fe/css/style-fe.css?<?=mt_rand();?>" rel="stylesheet">
...
})(window,document,'script','dataLayer','GTM-KGG9WC2');</script>
<!-- End Google Tag Manager -->


<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-GZJEP38F4S"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-GZJEP38F4S');
</script>