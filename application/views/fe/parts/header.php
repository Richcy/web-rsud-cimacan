...
<div class="container d-flex align-items-center">
  ...
  <!-- navbar above mobile's resolution -->
    ...
    <ul>
      ...
      <li class="dropdown">
        ...
        <ul>
          ...
          <li class="navbar-child"><a class="<?=$cur_page=='maklumat_pelayanan' ? 'active' : '';?>" href="<?=base_url('maklumat_pelayanan.html')?>">Maklumat Pelayanan</a></li>
  ...
  <!-- end navbar above mobile's resolution -->

  <!-- Mobile's resolution navbar -->
  <nav id="navbar" class="navbar order-lg-0 hidden-lg hidden-md">
    <ul>
      <li><a class="nav-link <?=$cur_page=='home' || $this->uri->segment(1)=='' ? 'active' : '';?>" href="<?=base_url()?>">Beranda</a></li>

      <!-- dropdown tentang menu -->
      <li class="dropdown">
        <a href="javascript:void();" class="nav-parent <?=$dropdown_parent_tentang;?>"><span>Tentang</span>
          <i class="bi bi-chevron-down"></i>
        </a>
  ...
  <!-- end Mobile's resolution navbar -->
