...
class T_Article extends CI_Model {
	...
	{
    $query = $this->db->select('article.id, article.title, article.description, article.category, article.create_date, article.update_date, article.img, category.id as category_id, category.name as category_name');
