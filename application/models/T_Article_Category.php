<?php 
class T_Article_Category extends CI_Model {
  ...
  {
    $query =  $this->db->where('id', $id);
    $query =  $this->db->update('t_article_category', $data);
    return $query;
  }
  ...
  public function update_sort($id, $sort)
  {
    ...
    $query =  $this->db->where('id', $id);
    $query =  $this->db->update('t_article_category');
    return $query;
  }
  ...
  {
    $query =  $this->db->where('id', $id);
    $query =  $this->db->delete('t_article_category');
    return $query;
  }
